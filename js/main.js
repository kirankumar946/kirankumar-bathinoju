jQuery(document).ready(function($) {
	...
	'use strict';
        ...
        function mouseEvent(e, delta) {
            // Check if the scroll is within a content area that has its own scrolling
            var target = e.target || e.srcElement;
            var isContentScroll = $(target).closest('.content').length > 0;
            
            // Only trigger slide navigation if not scrolling within content
            if (!isContentScroll) {
